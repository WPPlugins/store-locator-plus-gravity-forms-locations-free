...
Donate link: https://www.storelocatorplus.com/product/gravity-forms-integration/
...
* [Store Locator Plus](https://www.storelocatorplus.com/product/store-locator-plus/)
* [Other CSA Plugins](https://profiles.wordpress.org/charlestonsw/)
* [Other DeBAAT Plugins](https://profiles.wordpress.org/debaat/)

== Installation ==

= Requirements =

* Store Locator Plus: 4.4+
* Gravity Forms: 1.8+
* Wordpress: 4.0+
* PHP: 5.2.4+
